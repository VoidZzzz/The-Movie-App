const MAIN_PAGE_APP_BAR_TITLE = "Discover";
const MAIN_SCREEN_BEST_POPULAR_MOVIE_AND_SERIALS = "BEST POPULAR MOVIES AND SERIALS";
const SHOW_CASES_TITLES = "SHOWCASES";
const SHOW_CASES_SEE_MORE = "MORE SHOWCASES";
const BEST_ACTORS_TITLES = "BEST ACTORS";
const BEST_ACTORS_SEE_MORE = "MORE ACTORS";
const MAIN_SCREEN_CHECK_MOVIES_SHOWTIMES = "Check Movie\nShowTimes";
...
const MOVIE_DETAILS_RELATED_MOVIES = "RELATED MOVIES";